  ...
  <div class="text-center">
    ...
    <div class="container mb-5">
      ...
      <div class="row text-center align-items-center">
        <div class="col-lg"><img src="/site-images/n64-1000.png" class="img-fluid"></div>
        <div class="col-lg">
      ...
      <br />
      <div class="row text-center align-items-center">
        <div class="col-lg order-lg-12"><img src="/site-images/fds-zelda-300.png" class="img-fluid"></div>
      ...
      <br />
      <div class="row text-center align-items-center">
        <div class="col-lg"><img src="/site-images/collection-500.jpg" class="img-fluid"></div>
        <div class="col-lg">
      ...
      <br />
      <div class="row text-center align-items-center">
        <div class="col-lg order-lg-12"><img src="/site-images/photos-500.jpg" class="img-fluid"></div>
        <div class="col-lg order-lg-1">
